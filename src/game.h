...
int game_new ();
int is_game_end ();
int game_draw (GtkWidget *widget, cairo_surface_t *surface, gint height, gint width,
               gint tile_size, int force);
int game_draw_cell (GtkWidget *widget, cairo_surface_t *surface, gint height, gint width,
